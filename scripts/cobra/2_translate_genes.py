...
def clean_bool_expr(s: str) -> str:
    ...
    s = s.replace("() or ", "")
    s = s.replace("or (GFH29212.1", "or GFH29212.1")
    s = s.replace("or (KAL6761838.1", "or KAL6761838.1")
    s = s.replace("or (KAL6761940.1", "or KAL6761940.1")
...
if __name__=="__main__":
    ...
    for s in strains:
        ...
        write_excel(models_dict[s], out_dir / f"{s}.xlsx")
